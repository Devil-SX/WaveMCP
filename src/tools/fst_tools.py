"""FST waveform MCP tools."""

from pathlib import Path

from mcp.server.fastmcp import FastMCP

from ..parsers import FstParser, get_fst_parser, set_fst_parser


def register(mcp: FastMCP):
    """Register FST tools with the MCP server."""

    @mcp.tool()
    async def load_fst_file(fst_path: str, max_file_size_mb: int = 100) -> str:
